...
Usage:
    # 1. 基础用法：生成纯原图视频
    python manu/videos/make_sequence_video.py --seq wg2022_ir_020_split_03

    # 2. 覆盖默认路径与帧率
    python manu/videos/make_sequence_video.py \
    ...
    python manu/videos/make_sequence_video.py --seq wg2022_ir_020_split_03 --draw-gt
"""
