...
Features:
1. Pure PyTorch U-Net architecture (manu/models/irstd_unet_model.py) without modifying YOLO26 internals.
...
Example server command:
    python manu/training/train_irstd_unet.py --data /mnt/data/siping/datasets/manu/uav/data.yaml --device 0,1,2,3 --batch 32 --epochs 30 --stride 2
"""
